run_analysis <- function() {
          ...
          ## Combine rows of train and test data sets
          ...
          return(head(all_data_gathered,50)) ## display top 50 of tidy data
}
